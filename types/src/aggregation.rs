...
pub struct GetAggregatedDataResponse {
    ...
    pub status: i32,
    /// The transaction hash associated with the proof
    #[prost(bytes = "vec", tag = "3")]
    pub transaction_hash: ::prost::alloc::vec::Vec<u8>,
    /// The chain ID where the transaction occurred
    #[prost(uint64, tag = "4")]
    pub chain_id: u64,
    /// The contract address that generated the proof
...
pub struct ProcessBatchResponse {
    ...
    #[prost(bytes = "vec", tag = "1")]
    pub leaves: ::prost::alloc::vec::Vec<u8>,
}
#[derive(serde::Serialize, serde::Deserialize, Clone, PartialEq, ::prost::Message)]
...
#[derive(
    serde::Serialize, serde::Deserialize, sqlx::FromRow, Clone, PartialEq, ::prost::Message,
)]
...
pub mod aggregation_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::GetAggregatedDataResponse>, tonic::Status>
        {
        ...
        ) -> std::result::Result<tonic::Response<super::GetAggregationStatusResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::AggregateProofResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::GetBatchResponse>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/aggregation.AggregationService/GetBatch");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "aggregation.AggregationService",
                "GetBatch",
        ...
        ) -> std::result::Result<tonic::Response<super::WriteMerkleTreeResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::ProcessBatchResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/aggregation.AggregationService/ProcessBatch",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "aggregation.AggregationService",
        ...
        ) -> std::result::Result<tonic::Response<super::UpdateBatchStatusResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/aggregation.AggregationService/GetAggregatedData" => {
                        ...
                        for GetAggregatedDataSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AggregationService>::get_aggregated_data(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/aggregation.AggregationService/GetAggregationStatus" => {
                        ...
                        for GetAggregationStatusSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AggregationService>::get_aggregation_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/aggregation.AggregationService/AggregateProof" => {
                        ...
                        for AggregateProofSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AggregationService>::aggregate_proof(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/aggregation.AggregationService/GetBatch" => {
                    ...
                    impl<T: AggregationService> tonic::server::UnaryService<super::GetBatchRequest> for GetBatchSvc<T> {
                ...
                "/aggregation.AggregationService/WriteMerkleTree" => {
                        ...
                        for WriteMerkleTreeSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AggregationService>::write_merkle_tree(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/aggregation.AggregationService/ProcessBatch" => {
                    #[allow(non_camel_case_types)]
                    struct ProcessBatchSvc<T: AggregationService>(pub Arc<T>);
                    impl<T: AggregationService>
                        ...
                        for ProcessBatchSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AggregationService>::process_batch(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/aggregation.AggregationService/UpdateBatchStatus" => {
                        ...
                        for UpdateBatchStatusSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AggregationService>::update_batch_status(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
